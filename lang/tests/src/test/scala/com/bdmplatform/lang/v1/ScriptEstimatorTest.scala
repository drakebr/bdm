...
import com.bdmplatform.lang.{Common, Global}
...
import com.bdmplatform.lang.utils.functionCosts
import com.bdmplatform.lang.v1.FunctionHeader.User
import com.bdmplatform.lang.v1.compiler.Terms._
import com.bdmplatform.lang.v1.compiler.{ExpressionCompiler, Terms}
...
import com.bdmplatform.lang.v1.evaluator.ctx.impl.PureContext.sumLong
import com.bdmplatform.lang.v1.evaluator.ctx.impl.bdm.{Types, BdmContext}
...
class ScriptEstimatorTest(estimator: ScriptEstimator)
  ...
  protected val ctx = {
    ...
    Monoid
      .combineAll(Seq(
        ...
        BdmContext.build(DirectiveSet.contractDirectiveSet),
        CTX[NoContext](
          Seq(transactionType),
  ...
  property("script complexity should be constant") {
    ...
    val costs = com.bdmplatform.lang.utils.functionCosts(V2)
