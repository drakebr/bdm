package com.bdmplatform.lang.compiler

import cats.kernel.Monoid
import com.google.protobuf.ByteString
import com.bdmplatform.common.state.ByteStr
import com.bdmplatform.common.utils.EitherExt2
import com.bdmplatform.lang.Common
import com.bdmplatform.lang.Common.{NoShrink, produce}
...
import com.bdmplatform.lang.v1.compiler.{CompilerContext, Terms}
import com.bdmplatform.lang.v1.evaluator.FunctionIds
import com.bdmplatform.lang.v1.evaluator.ctx.impl.bdm.{FieldNames, Types, BdmContext}
import com.bdmplatform.lang.v1.evaluator.ctx.impl.{CryptoContext, PureContext}
import com.bdmplatform.lang.v1.parser.Parser
import com.bdmplatform.lang.v1.testing.ScriptGen
import com.bdmplatform.lang.v1.traits.Environment
import com.bdmplatform.lang.v1.{ContractLimits, compiler}
import com.bdmplatform.protobuf.dapp.DAppMeta
import com.bdmplatform.protobuf.dapp.DAppMeta.CallableFuncSignature
...
class ContractCompilerTest extends PropSpec with PropertyChecks with Matchers with ScriptGen with NoShrink {
  ...
  property("hodlContract") {
    val ctx = Monoid
      .combineAll(
        Seq(
          PureContext.build(com.bdmplatform.lang.Global, V3).withEnvironment[Environment],
          CryptoContext.build(com.bdmplatform.lang.Global, V3).withEnvironment[Environment],
          BdmContext.build(
            DirectiveSet(V3, Account, DAppType).explicitGet()
          )
        ))
    ...
    val expr = {
      val script =
        """
          ...
          |   else TransferSet([ScriptTransfer(i.caller, bdmBalance(this), base58'somestr')])
          | }
          |
          | @Verifier(t)
          | func verify() = {
