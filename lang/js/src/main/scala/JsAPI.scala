...
import com.bdmplatform.DocSource
import com.bdmplatform.common.utils.EitherExt2
import com.bdmplatform.lang.{Global, Version}
import com.bdmplatform.lang.contract.DApp
import com.bdmplatform.lang.contract.meta.RecKeyValueFolder
import com.bdmplatform.lang.directives.Directive.extractDirectives
import com.bdmplatform.lang.directives.values.{DApp => DAppType, _}
import com.bdmplatform.lang.directives.{DirectiveDictionary, DirectiveParser, DirectiveSet}
...
import com.bdmplatform.lang.v1.compiler.Types._
...
import com.bdmplatform.lang.v1.repl.Repl
import com.bdmplatform.lang.v1.repl.node.http.NodeConnectionSettings
import com.bdmplatform.lang.v1.traits.Environment
import com.bdmplatform.lang.v1.{CTX, ContractLimits}
...
object JsAPI {
  ...
  private def bdmContext(v: StdLibVersion, isTokenContext: Boolean, isContract: Boolean) =
    BdmContext.build(
  ...
  private def buildScriptContext(v: StdLibVersion, isTokenContext: Boolean, isContract: Boolean): CTX[Environment] =
    Monoid.combineAll(Seq(pureContext(v), cryptoContext(v), bdmContext(v, isTokenContext, isContract)))

  private def buildContractContext(v: StdLibVersion): CTX[Environment] =
    Monoid.combineAll(Seq(pureContext(v), cryptoContext(v), bdmContext(v, false, true)))
