package com.bdmplatform.lang.contract

import com.bdmplatform.lang.contract.DApp.{CallableFunction, VerifierFunction}
import com.bdmplatform.lang.v1.compiler.CompilationError.Generic
import com.bdmplatform.lang.v1.compiler.Terms.DECLARATION
import com.bdmplatform.lang.v1.compiler.Types._
import com.bdmplatform.lang.v1.compiler.{CompilationError, Terms}
...
object DApp {
  ...
  case class CallableAnnotation(invocationArgName: String) extends Annotation {
    lazy val dic = Map(invocationArgName -> com.bdmplatform.lang.v1.evaluator.ctx.impl.bdm.Types.invocationType)
  }
