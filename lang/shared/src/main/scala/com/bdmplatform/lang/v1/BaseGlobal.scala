...
import com.bdmplatform.lang.contract.meta.{Chain, Dic, MetaMapper, MetaMapperStrategyV1, MetaVersion}
import com.bdmplatform.lang.contract.{ContractSerDe, DApp}
import com.bdmplatform.lang.directives.values.{Expression, StdLibVersion, DApp => DAppType}
...
import com.bdmplatform.lang.{ValidationError, utils}
import com.bdmplatform.lang.v1.compiler.Terms.EXPR
import com.bdmplatform.lang.v1.compiler.{CompilerContext, ContractCompiler, ExpressionCompiler, Terms}
...
import com.bdmplatform.lang.v1.repl.node.http.response.model.NodeResponse
...
trait BaseGlobal {
  ...
  private def compile(
    ...
    for {
      ...
      illegalBlockVersionUsage = letBlockOnly && com.bdmplatform.lang.v1.compiler.сontainsBlockV2(ex)
