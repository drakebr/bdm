package com.bdmplatform.lang.v1.compiler

import cats.{Id, Show}
import cats.implicits._
import com.bdmplatform.lang.contract.DApp
import com.bdmplatform.lang.contract.DApp._
import com.bdmplatform.lang.contract.meta.{MetaMapper, V1}
import com.bdmplatform.lang.v1.compiler.CompilationError.{AlreadyDefined, Generic, WrongArgumentType}
import com.bdmplatform.lang.v1.compiler.CompilerContext.vars
import com.bdmplatform.lang.v1.compiler.ExpressionCompiler._
import com.bdmplatform.lang.v1.compiler.Terms.DECLARATION
import com.bdmplatform.lang.v1.compiler.Types.{BOOLEAN, UNION}
import com.bdmplatform.lang.v1.evaluator.ctx.FunctionTypeSignature
import com.bdmplatform.lang.v1.evaluator.ctx.impl.bdm.{FieldNames, Types => BdmTypes}
import com.bdmplatform.lang.v1.parser.Expressions.{FUNC, PART, Pos}
import com.bdmplatform.lang.v1.parser.{Expressions, Parser}
import com.bdmplatform.lang.v1.task.imports._
      ...
      case (List(c: CallableAnnotation), (func, tpe, typedParams)) =>
        for {
          _ <- Either
            .cond(
              tpe match {
                case _ if tpe <= UNION(BdmTypes.writeSetType, BdmTypes.scriptTransferSetType, BdmTypes.scriptResultType) =>
                  true
                case _ => false
              },
              (),
