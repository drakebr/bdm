package com.bdmplatform.lang.script.v1
...
import com.bdmplatform.lang.v1.ContractLimits._
...
object ExprScript {
  ...
  private case class ExprScriptImpl(stdLibVersion: StdLibVersion, expr: EXPR) extends ExprScript {
    ...
    override val containsBlockV2: Coeval[Boolean] = Coeval.evalOnce(com.bdmplatform.lang.v1.compiler.сontainsBlockV2(expr))
  }
