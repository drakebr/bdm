...
import com.bdmplatform.lang.directives.values.{StdLibVersion, V3}
import com.bdmplatform.lang.v1.compiler.Terms._
import com.bdmplatform.lang.v1.evaluator.ctx.impl.converters
import com.bdmplatform.lang.v1.traits.domain.Tx._
...
object Bindings {
  ...
  def buildPayment(mpmt: Option[Tx.Pmt]): CaseObj = mpmt match {
    case None => com.bdmplatform.lang.v1.evaluator.ctx.impl.unit
    case Some(pmt) =>
      CaseObj(
        paymentType,
        Map(
