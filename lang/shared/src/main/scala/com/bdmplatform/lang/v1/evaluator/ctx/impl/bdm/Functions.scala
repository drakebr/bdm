...
import com.bdmplatform.lang.ExecutionError
...
import com.bdmplatform.lang.v1.compiler.Types.{BYTESTR, LIST, LONG, STRING, UNION, UNIT, optionLong}
import com.bdmplatform.lang.v1.evaluator.FunctionIds._
import com.bdmplatform.lang.v1.evaluator.{Contextful, ContextfulNativeFunction, ContextfulUserFunction}
import com.bdmplatform.lang.v1.evaluator.ctx.{BaseFunction, NativeFunction, UserFunction}
import com.bdmplatform.lang.v1.evaluator.ctx.impl.{EnvironmentFunctions, PureContext, notImplemented, unit}
import com.bdmplatform.lang.v1.evaluator.ctx.impl.bdm.Types.{addressOrAliasType, addressType, dataEntryType, optionAddress}
import com.bdmplatform.lang.v1.traits.{DataType, Environment}
import Bindings._
import Types._
import com.bdmplatform.lang.directives.values.StdLibVersion
import com.bdmplatform.lang.v1.evaluator.ctx.impl.converters._
import com.bdmplatform.lang.v1.traits.domain.Recipient
...
object Functions {
  ...
  val bdmBalanceF: BaseFunction[Environment] =
    UserFunction("bdmBalance", 109, LONG, ("@addressOrAlias", addressOrAliasType)) {
