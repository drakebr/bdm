package com.bdmplatform.lang.v1.evaluator.ctx.impl

import cats.{Id, Monad}
import com.bdmplatform.common.state.ByteStr
import com.bdmplatform.lang.directives.values.{StdLibVersion, V3, _}
import com.bdmplatform.lang.v1.compiler.Terms.{CONST_BOOLEAN, CONST_BYTESTR, CONST_STRING, CaseObj}
import com.bdmplatform.lang.v1.compiler.Types.{BOOLEAN, BYTESTR, CASETYPEREF, FINAL, STRING, UNION}
...
import com.bdmplatform.lang.v1.evaluator.ContextfulVal
import com.bdmplatform.lang.v1.evaluator.FunctionIds._
import com.bdmplatform.lang.v1.evaluator.ctx.impl.crypto.RSA.DigestAlgorithm
import com.bdmplatform.lang.v1.evaluator.ctx.{BaseFunction, EvaluationContext, NativeFunction}
import com.bdmplatform.lang.v1.{BaseGlobal, CTX}
...
object CryptoContext {
  ...
  private def algFromCO(obj: Terms.CaseObj): Either[String, DigestAlgorithm] = {
    import com.bdmplatform.lang.v1.evaluator.ctx.impl.crypto.RSA._
    obj match {
