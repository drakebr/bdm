...
import com.bdmplatform.common.state.ByteStr.toByteArray
...
object PBTransactions {
  import com.bdmplatform.protobuf.utils.PBInternalImplicits._
//========
import _root_.com.bdmplatform.common.state.ByteStr.toByteArray
import com.bdmplatform.common.state.ByteStr.toByteArray
import _root_.com.bdmplatform.common.state.ByteStr.{fromByteArray, toByteArray, fromBytes, fromLong}
//=======
  ...
  def create(
      sender: com.bdmplatform.account.PublicKey = PublicKey.empty,
      chainId: Byte = 0,
      fee: Long = 0L,
      feeAssetId: VanillaAssetId = Bdm,
      timestamp: Long = 0L,
      version: Int = 0,
      proofsArray: Seq[com.bdmplatform.common.state.ByteStr] = Nil,
...
//=======
    ...
    val result: Either[ValidationError, VanillaTransaction] = data match {
      ...
      case Data.CreateAlias(CreateAliasTransactionData(alias)) =>
        version match {
          case 1 =>
            for {
              alias <- com.bdmplatform.account.Alias.createWithChainId(alias, chainId)
      ...
      case Data.InvokeScript(InvokeScriptTransactionData(Some(dappAddress), functionCall, payments)) =>
        ...
        import com.bdmplatform.lang.v1.Serde
        ...
        version match {
          case 1 =>
            vt.CreateAliasTransactionV1(
              sender,
              com.bdmplatform.account.Alias.createWithChainId(alias, chainId).explicitGet(),
              feeAmount,
              timestamp,
              signature
            )
  ...
  def protobuf(tx: VanillaTransaction): PBSignedTransaction = {
    ...
    tx match {
      ...
      case vt.PaymentTransaction(sender, recipient, amount, fee, timestamp, signature) =>
        ...
        PBTransactions.create(sender, chainId, fee, Bdm, timestamp, 1, Seq(signature), Data.Payment(data))
  ...
  def toVanillaDataEntry(de: DataTransactionData.DataEntry): com.bdmplatform.state.DataEntry[_] = {
  ...
  def toPBDataEntry(de: com.bdmplatform.state.DataEntry[_]): DataTransactionData.DataEntry = {
