package com.bdmplatform.transaction.description

import cats.{Functor, Semigroupal}
import com.google.common.primitives.{Ints, Longs, Shorts}
import com.bdmplatform.account.{Address, AddressOrAlias, Alias, PublicKey}
import com.bdmplatform.common.state.ByteStr
import com.bdmplatform.common.utils.EitherExt2
import com.bdmplatform.crypto.{KeyLength, SignatureLength}
...
import com.bdmplatform.lang.v1.{ContractLimits, Serde}
...
import com.bdmplatform.transaction.TxValidationError.Validation
...
case class PaymentBytes(index: Int, name: String) extends ByteEntity[Payment] {
  ...
  def deserialize(buf: Array[Byte], offset: Int): Try[(Payment, Int)] = {
    Try {
      ...
      val asset             = maybeAssetId.fold[Asset](Bdm)(IssuedAsset)
