...
import com.bdmplatform.account.{Address, AddressOrAlias, Alias}
import com.bdmplatform.common.state.ByteStr
import com.bdmplatform.lang.v1.compiler.Terms.EVALUATED
import com.bdmplatform.lang.v1.traits.domain.Tx.{Header, Proven}
import com.bdmplatform.lang.v1.traits.domain._
import com.bdmplatform.state._
import com.bdmplatform.transaction._
import com.bdmplatform.transaction.assets._
import com.bdmplatform.transaction.assets.exchange.OrderType.{BUY, SELL}
import com.bdmplatform.transaction.assets.exchange.{AssetPair, ExchangeTransaction, Order}
    ...
    tx match {
      ...
      case ms: MassTransferTransaction =>
        Tx.MassTransfer(
          ...
          transfers = ms.transfers.map(r => com.bdmplatform.lang.v1.traits.domain.Tx.TransferItem(r.address, r.amount)).toIndexedSeq,
