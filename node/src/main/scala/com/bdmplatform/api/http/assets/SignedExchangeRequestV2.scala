...
import com.bdmplatform.transaction.assets.exchange.{ExchangeTransaction, ExchangeTransactionV2, Order}
...
object SignedExchangeRequestV2 {
  implicit val orderFormat: Format[Order] = com.bdmplatform.transaction.assets.exchange.OrderJson.orderFormat
