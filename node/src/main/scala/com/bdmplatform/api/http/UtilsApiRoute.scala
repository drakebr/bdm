...
import com.bdmplatform.account.PrivateKey
import com.bdmplatform.api.http.ApiError.{ScriptCompilerError, TooBigArrayAllocation}
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        name = "code",
        required = true,
        dataType = "com.bdmplatform.api.http.ScriptWithImportsRequest",
        paramType = "body",
