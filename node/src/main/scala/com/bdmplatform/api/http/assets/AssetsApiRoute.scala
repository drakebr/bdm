package com.bdmplatform.api.http.assets
...
import com.bdmplatform.api.common.{CommonAccountApi, CommonAssetsApi}
import com.bdmplatform.api.http.ApiError._
import com.bdmplatform.api.http._
import com.bdmplatform.api.http.assets.AssetsApiRoute.DistributionParams
import com.bdmplatform.common.state.ByteStr
import com.bdmplatform.common.utils.Base58
import com.bdmplatform.http.{BroadcastRoute, CustomJson}
...
import com.bdmplatform.transaction.assets.exchange.OrderJson._
import com.bdmplatform.transaction.smart.script.ScriptCompiler
import com.bdmplatform.transaction.{AssetIdStringLength, TransactionFactory, TxValidationError}
import com.bdmplatform.utils.{Time, _}
      ...
      val distributionTask = assetEi match {
        ...
        case Right(asset) =>
          Task
            ...
            .map(dst => Json.toJson(dst)(com.bdmplatform.state.dstWrites): ToResponseMarshallable)
      }
