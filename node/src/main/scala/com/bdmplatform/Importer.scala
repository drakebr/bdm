...
import com.bdmplatform.Exporter.Formats
...
object Importer extends ScorexLogging {
  ...
  private[this] final case class ImportOptions(configFile: File = new File("bdm-testnet.conf"),
  ...
  private[this] lazy val commandParser = {
    ...
    OParser.sequence(
      programName("bdm import"),
      head("Bdm Blockchain Importer", Version.VersionString),
      opt[File]('c', "config")
