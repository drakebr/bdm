...
import com.bdmplatform.mining.Miner.MaxTransactionsPerMicroblock
import com.bdmplatform.network.message.Message._
import com.bdmplatform.network.message._
...
object TransactionSpec extends MessageSpec[Transaction] {
  ...
  // Modeled after Data Transaction https://bdmplatform.atlassian.net/wiki/spaces/MAIN/pages/119734321/Data+Transaction
