...
import com.bdmplatform.transaction.TxValidationError.InvalidAddress
import com.bdmplatform.utils.{ScorexLogging, base58Length}
...
object Address extends ScorexLogging {
  ...
  private[bdmplatform] def createUnsafe(address: ByteStr): Address = {
