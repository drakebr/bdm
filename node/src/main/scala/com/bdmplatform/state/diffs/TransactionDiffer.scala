...
import com.bdmplatform.transaction.TxValidationError.UnsupportedTransactionType
...
import com.bdmplatform.transaction.smart.{InvokeScriptTransaction, SetScriptTransaction, Verifier}
