...
import com.bdmplatform.consensus.GeneratingBalanceProvider
...
import com.bdmplatform.transaction.TxValidationError.{AliasDoesNotExist, GenericError}
...
package object state {
  ...
  implicit class BlockchainExt(private val blockchain: Blockchain) extends AnyVal {
    ...
    def bdmPortfolio(address: Address): Portfolio = Portfolio(
