...
import com.bdmplatform.state.utils.{BlockchainAddressTransactionsList, _}
import com.bdmplatform.state.{BlockchainUpdaterImpl, Height, TransactionId, TxNum}
import com.bdmplatform.transaction.Asset.Bdm
import com.bdmplatform.transaction.smart.SetScriptTransaction
import com.bdmplatform.transaction.transfer.{TransferTransaction, TransferTransactionV1}
import com.bdmplatform.transaction.{GenesisTransaction, Transaction}
import com.bdmplatform.utils.Time
import com.bdmplatform.{RequestGen, TransactionGen, WithDB}
...
class LevelDBWriterSpec
  ...
  def createTransfer(master: KeyPair, recipient: Address, ts: Long): TransferTransaction = {
    TransferTransactionV1
      .selfSigned(Bdm, master, recipient, ENOUGH_AMT / 5, ts, Bdm, 1000000, Array.emptyByteArray)
      .explicitGet()
  }
