...
import com.bdmplatform.account.{Address, AddressOrAlias}
import com.bdmplatform.api.http.AddressApiRoute
...
// [WAIT] import com.bdmplatform.lang.{Global, StdLibVersion}
import com.bdmplatform.lang.contract.DApp
import com.bdmplatform.lang.contract.DApp.{VerifierAnnotation, VerifierFunction}
// [WAIT] import com.bdmplatform.lang.v1.compiler.Decompiler
import com.bdmplatform.lang.v1.compiler.Terms._
// [WAIT] import com.bdmplatform.lang.v1.evaluator.ctx.impl.{CryptoContext, PureContext}
...
import com.bdmplatform.{NoShrink, TestTime, TestWallet, crypto}
...
class AddressRouteSpec
  ...
  routePath(s"/scriptInfo/${allAddresses(1)}") in {
    ...
    Get(routePath(s"/scriptInfo/${allAddresses(3)}")) ~> route ~> check {
      ...
      // [WAIT]                                           Decompiler(
      //      testContract,
      //      Monoid.combineAll(Seq(PureContext.build(com.bdmplatform.lang.directives.values.StdLibVersion.V3), CryptoContext.build(Global))).decompilerContext)
