...
import com.bdmplatform.transaction.assets.{IssueTransactionV1, ReissueTransactionV2}
import org.scalacheck.Gen
import play.api.libs.json._

class ReissueTransactionV2Specification extends GenericTransactionSpecification[ReissueTransactionV2] {

  def transactionParser: com.bdmplatform.transaction.TransactionParserFor[ReissueTransactionV2] = ReissueTransactionV2
  ...
  def generator: Gen[((Seq[com.bdmplatform.transaction.Transaction], ReissueTransactionV2))] =
    for {
