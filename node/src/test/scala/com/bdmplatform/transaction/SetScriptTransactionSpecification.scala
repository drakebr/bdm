...
class SetScriptTransactionSpecification extends GenericTransactionSpecification[SetScriptTransaction] {
  ...
  def transactionParser: com.bdmplatform.transaction.TransactionParserFor[SetScriptTransaction] = SetScriptTransaction
  ...
  def generator: Gen[((Seq[com.bdmplatform.transaction.Transaction], SetScriptTransaction))] = setScriptTransactionGen.map(t => (Seq(), t))
