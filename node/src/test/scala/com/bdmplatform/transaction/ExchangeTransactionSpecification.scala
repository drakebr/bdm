...
import com.bdmplatform.transaction.TxValidationError.OrderValidationError
...
import com.bdmplatform.{NTPTime, TransactionGen}
  ...
  property("ExchangeTransaction balance changes") {
    ...
    forAll(preconditions) {
      case (sender1, sender2, matcher, pair, buyerMatcherFeeAssetId, sellerMatcherFeeAssetId, versions) =>
        ...
        create(
          buyOrder = buy.updatePair(buy.assetPair.copy(amountAsset = Bdm)),
