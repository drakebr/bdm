...
import com.bdmplatform.settings.{Constants, GenesisSettings, GenesisTransactionSettings}
import com.bdmplatform.transaction.transfer.TransferTransaction
import com.bdmplatform.transaction.{GenesisTransaction, Transaction, TransactionParser}
    ...
    genesisBlock = Block
      .genesis(
        GenesisSettings(
          ...
          Constants.TotalBdm,
          None,
          Seq(GenesisTransactionSettings(sender.toAddress.stringRepr, Constants.TotalBdm)),
          1000,
          1.minute
        )
      )
