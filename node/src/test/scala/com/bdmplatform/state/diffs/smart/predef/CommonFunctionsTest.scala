...
import com.bdmplatform.lang.v1.compiler.Terms.CONST_BYTESTR
    ...
    forAll(transferV1Gen) {
      case transfer =>
        ...
        transfer.assetId match {
          ...
          case Bdm          => result should produce("extract() called on unit")
        }
    }
  }
  ...
  property("isDefined should return true if transfer assetId exists") {
    forAll(transferV1Gen) {
      case transfer =>
        ...
        result shouldEqual evaluated(transfer.assetId != Bdm)
    }
  }
