...
import com.bdmplatform.account.{AddressScheme, KeyPair}
...
import com.bdmplatform.lagonaki.mocks.TestBlock._
...
import com.bdmplatform.state.diffs.{ENOUGH_AMT, FeeValidation, assertDiffAndState}
  ...
  val preconditionsAndPayments = for {
    ...
    untypedScript <- Gen
      ...
      .map {
        ...
        case 2 => scriptWithV1BdmFunctions(dataTransaction, transfer)
