...
import com.bdmplatform.consensus.FairPoSCalculator
...
import com.bdmplatform.it.api.AsyncNetworkApi.NodeAsyncNetworkApi
import com.bdmplatform.it.api.SyncHttpApi._
import com.bdmplatform.it.transactions.NodesFromDocker
import com.bdmplatform.it.{NodeConfigs, WaitForHeight2}
import com.bdmplatform.network.RawBytes
...
class PoSSuite extends FunSuite with Matchers with NodesFromDocker with WaitForHeight2 with CancelAfterFailure {
  ...
  override protected def nodeConfigs: Seq[Config] =
    NodeConfigs.newBuilder
      ...
      .withDefault(3)
      .withSpecial(_.raw("bdm.miner.enable = yes"))
      .buildNonConflicting()
