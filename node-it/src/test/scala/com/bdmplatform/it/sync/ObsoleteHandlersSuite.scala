...
import com.bdmplatform.api.http.alias.CreateAliasV1Request
import com.bdmplatform.api.http.assets.{
  BurnV1Request,
  IssueV1Request,
  MassTransferRequest,
  ReissueV1Request,
...
import com.bdmplatform.api.http.leasing.{LeaseCancelV1Request, LeaseV1Request, SignedLeaseCancelV1Request, SignedLeaseV1Request}
...
import com.bdmplatform.api.http.DataRequest
...
class ObsoleteHandlersSuite extends BaseTransactionSuite {
  ...
  test("assets masstransfer") {
    ...
    val transfers                               = List(Transfer(secondAddress, 1.bdm), Transfer(thirdAddress, 2.bdm))
