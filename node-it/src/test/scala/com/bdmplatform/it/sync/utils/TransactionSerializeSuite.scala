package com.bdmplatform.it.sync.utils

import com.bdmplatform.account.{Address, AddressScheme, Alias, PublicKey}
...
import com.bdmplatform.state.{BinaryDataEntry, BooleanDataEntry, IntegerDataEntry}
...
import com.bdmplatform.transaction.lease.{LeaseCancelTransactionV1, LeaseCancelTransactionV2, LeaseTransactionV1, LeaseTransactionV2}
...
import com.bdmplatform.transaction.transfer.{MassTransferTransaction, TransferTransactionV1, TransferTransactionV2}
import com.bdmplatform.transaction.{CreateAliasTransactionV1, CreateAliasTransactionV2, DataTransaction, Proofs}
...
class TransactionSerializeSuite extends BaseTransactionSuite with TableDrivenPropertyChecks {
  ...
  private val buyV2 = OrderV2(
    ...
    AssetPair.createAssetPair("BDM", "9ZDWzK53XT5bixkmMwTJi2YzgxCqn5dUajXFcT2HcFDy").get,
    OrderType.BUY,
    2,
    60.bdm,
    tsOrderFrom,
  ...
  private val transfers = MassTransferTransaction
    .parseTransfersList(List(Transfer(firstAddress, 1.bdm), Transfer(secondAddress, 2.bdm)))
    .right
    .get
