...
import com.bdmplatform.it.{ExternalNode, GrpcIntegrationSuiteWithThreeAddress, GrpcWaitForHeight, Node, NodeConfigs}
...
trait GrpcBaseTransactionSuiteLike
  ...
  protected val theNodes: Coeval[Seq[Node]] = Coeval.evalOnce {
    Option(System.getProperty("bdm.it.config.file")) match {
