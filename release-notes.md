...
* By default walletDir and dataDir located in $HOME/bdm
...
* Upgrade to Bdm' Scorex v1.3.1

**0.2.0-RC7**

* New API /bdm/payment returns senderPublicKey
* New API /bdm/create-signed-payment
* /bdm/external-payment deprecated. 
  Use new /bdm/broadcast-signed-payment.
* New API /bdm/payment/signature
* minimumTxFee verification for API

**0.2.0-RC5**

* /bdm/external-payment returns error for incorrect recipient

**0.2.0-RC4**

* Fixed issue with incorrect Handshake
* Balance with confirmations is the minimum balance
* /bdm/external-payment returns error if account balance invalid
...
* Upgrade to Scorex 1.2.4. Clean /scorex/bdm/data/ before run.
