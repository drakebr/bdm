...
import com.bdmplatform.settings.{DBSettings, FunctionalitySettings}
...
trait BaseState {
  ...
  private val initGen: Gen[(KeyPair, Block)] = for {
    ...
    val genesisTx = GenesisTransaction.create(rich, bdm(100000000L), System.currentTimeMillis() - 10000).explicitGet()
