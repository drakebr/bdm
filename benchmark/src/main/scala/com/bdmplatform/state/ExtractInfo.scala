...
import com.bdmplatform.lang.v1.traits.DataType
...
import com.bdmplatform.transaction.{Authorized, CreateAliasTransactionV1, DataTransaction, Transaction}
...
object ExtractInfo extends App with ScorexLogging {
  ...
  try {
    val state = new LevelDBWriter(db, Observer.empty(UncaughtExceptionReporter.default), bdmSettings.blockchainSettings, bdmSettings.dbSettings)
