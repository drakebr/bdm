...
import com.bdmplatform.api.common.CommonTransactionsApi
import com.bdmplatform.lang.ValidationError
import com.bdmplatform.protobuf.transaction._
import com.bdmplatform.state.{Blockchain, Height, TransactionId}
import com.bdmplatform.transaction.AuthorizedTransaction
...
class TransactionsApiGrpcImpl(
  ...
  override def getStateChanges(request: TransactionsRequest, responseObserver: StreamObserver[InvokeScriptResult]): Unit =
    responseObserver.interceptErrors {
      import com.bdmplatform.state.{InvokeScriptResult => VISR}
